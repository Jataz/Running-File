...
<div style="display:grid;gap:12px">
  ...
  <form id="nf-form" class="panel" style="display:grid;grid-template-columns:repeat(2,1fr);gap:10px">
...
<script>
  (function(){
    ...
    form.addEventListener('submit', async (e)=>{
      ...
      try { await api('/api/files_create.php', { method:'POST', body: fd }); window.location.href = '/outbox'; }
